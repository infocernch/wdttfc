...
<body>
	...
	<form method="post" name="form1" id="form1">
		<textarea rows="3px" cols="70%" name="content" id="content"
			placeholder="내용을 입력하세요"><%=content%></textarea>
		<input name="commentNum" id="commentNum" value="<%=commentNum%>"
			type="hidden"> <input name="num" id="num" value="<%=num%>"
			type="hidden"> <input type="submit" id="btnEdit" value="수정">
...
$(function() {
	$("#btnEdit").click(function() {
        ...
        form.action="${path}/news_servlet/commentEdit.do";
      	$.ajax({
      		url:"${path}/news_servlet/commentEdit.do",
      		data:{num:num,commentNum:commentNum,content:content},
      		type:"post",
      		success: function() {
      			alert("댓글수정이 완료되었습니다.");
